# TODO:
# 1.
#    Zaimplementuj dodatkowe mechanizmy zabezpieczające, takie jak sól (salt),
#    aby hasła były jeszcze trudniejsze do złamania przez potencjalnego atakanta,
#    który miałby dostęp do przesyłanych danych lub bazy danych serwera.
# 2.
